 ...
 */
export function setLabels(new_labels: LabelConfig[]) {
...
export let labels = {
	...
	not_public:       { name: 'Unavailable video', type: 'ineligible', trigger: 'Empty metadata response',     details: 'Video is not public or is unavailable' },
