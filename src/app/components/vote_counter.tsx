...
import { labels, labelStamp } from "@/lib/labels";
...
export default function VoteCounter({ eligibleCount, uniqueCreatorCount }: Props) {
  ...
  const minStamp = labelStamp(labels.too_few_votes, has5)
  const diversityStamp = labelStamp(labels.diversity_rule, diverse)
